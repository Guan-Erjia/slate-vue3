<template>
  <header>
    ...
    <button v-if="isMobileDevice" :style="{ color: isFold ? 'white' : '#aaaaaa', }" @click="isFold = !isFold">
      {{ isFold ? 'Expand' : 'Fold' }} Menu
    </button>
    <a v-else style="margin-right: 20px;" href="https://docs.slatejs.org" target="_blank">Docs</a>
