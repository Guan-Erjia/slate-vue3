...
import { createEditor, Descendant, withDOM, Slate, Editable, RenderElementProps, defaultRenderPlaceHolder, DecoratedRange, NodeEntry, Text, RenderLeafProps, withHistory } from 'slate-vue3';
