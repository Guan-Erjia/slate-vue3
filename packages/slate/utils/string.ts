...
export const getCharacterDistance = (str: string, isRTL = false): number => {
  ...
  let gb11: boolean; // Is GB11 applicable?
...
// https://github.com/nodejs/node/pull/60523/changes
// Node 24 updates Unicode data and no longer classifies U+2701 (SCISSORS)
// as ExtPict, but our grapheme tests still rely on the previous GB11 behavior.
